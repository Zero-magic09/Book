// pages/auth/login-farmer/login-farmer.js
const app = getApp()
...
Page({
    ...
    handleRegister() {
        wx.navigateTo({
            url: '/pages/auth/register-farmer/register-farmer'
        });
    },
    ...
    handleSubmit() {
        ...
        console.log('Farmer login attempt:', this.data.account);
        ...
        post('/auth/login', {
            ...
            if (res.code === 200) {
                ...
                if (userInfo.role !== 'FARMER') {
                    wx.showToast({ title: '非农户账号', icon: 'none' });
                    return;
                }
